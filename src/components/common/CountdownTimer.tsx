  ...
  return (
    <div className="bg-[#2E3A41] rounded px-[10px] py-[5px] flex gap-10">
      <div className="flex flex-col items-center">
        <span className="text-4xl">{String(timeLeft.days).padStart(2, '0')}</span>
        <span className="text-xs">Days</span>
      </div>
      <div className="flex flex-col items-center">
        <span className="text-4xl">{String(timeLeft.hours).padStart(2, '0')}</span>
        <span className="text-xs">Hours</span>
      </div>
      <div className="flex flex-col items-center">
        <span className="text-4xl">{String(timeLeft.minutes).padStart(2, '0')}</span>
        <span className="text-xs">Minutes</span>
      </div>
      <div className="flex flex-col items-center">
        <span className="text-4xl">{String(timeLeft.seconds).padStart(2, '0')}</span>
